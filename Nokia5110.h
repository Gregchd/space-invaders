...
// Nokia5110.h (File Modified by Valentin Sarmiento)
...
/*****                            clearBuffer()                                     *****/
/****************************************************************************************/
/***** Limpia el Buffer interno Screen[] y asigna el valor de cero a cada uno de    *****/
/***** sus bytes.                                                                   *****/
/****************************************************************************************/
/***** ENTRADAS:    Ninguna                                                         *****/
/***** SALIDA:      Ninguna                                                         *****/
...
/*****                              fillBuffer()                                    *****/
/****************************************************************************************/
/***** Copia todo el contenido del arreglo ptr[] al Buffer interno Screen[]         *****/
/****************************************************************************************/
/***** ENTRADAS:    Direccion del arreglo a copiar                                  *****/
/***** SALIDA:      Ninguna                                                         *****/
/****************************************************************************************/
...
/*****                           copyToScreen()                                     *****/
/****************************************************************************************/
/***** Copia todo el contenido del arreglo interno Screen[] a la pantalla           *****/
/***** Nokia para poder visualizar el contenido de ese arreglo                      *****/
/****************************************************************************************/
/***** ENTRADAS:    Ninguna                                                         *****/
/***** SALIDA:      Ninguna                                                         *****/
/****************************************************************************************/
...
/*****                           setPixel()                                     *****/
/****************************************************************************************/
/***** Prende o Ilumina o Activa un determinado pixel de la pantalla NOKIA          *****/
/****************************************************************************************/
/***** ENTRADAS:    (x) posicion horizontal del pixel a activar                     *****/
/*****              (y) posicion vertical del pixel a activar                       *****/
/***** SALIDA:      Ninguna                                                         *****/
/****************************************************************************************/
...
/*****                           clearPixel()                                       *****/
/****************************************************************************************/
/***** Apaga o Desactiva un determinado pixel de la pantalla NOKIA                  *****/
/****************************************************************************************/
/***** ENTRADAS:    (x) posicion horizontal del pixel a desactivar                  *****/
/*****              (y) posicion vertical del pixel a desactivar                    *****/
/***** SALIDA:      Ninguna                                                         *****/
/****************************************************************************************/
